...
class Forwarding extends Module {
  ...
  when(io.reg_write_enable_mem && (io.rs1_ex === io.rd_mem) && (io.rs1_ex =/= 0.U)) {
  ...
  }.elsewhen(io.reg_write_enable_wb && (io.rs1_ex === io.rd_wb) && (io.rs1_ex =/= 0.U)) {
  ...
  when(io.reg_write_enable_mem && (io.rs2_ex === io.rd_mem) && (io.rs2_ex =/= 0.U)) {
  ...
  }.elsewhen(io.reg_write_enable_wb && (io.rs2_ex === io.rd_wb) && (io.rs2_ex =/= 0.U)) {
  ...
  when(io.reg_write_enable_mem && (io.rs1_id === io.rd_mem) && (io.rs1_id =/= 0.U)) {
    // Condition 1: MEM stage writes register
    // Condition 2: Register address match
    // Condition 3: Not x0 register
    //
  ...
  }.elsewhen(io.reg_write_enable_wb && (io.rs1_id === io.rd_wb) && (io.rs1_id =/= 0.U)) {
    // Condition 1: WB stage writes register
    // Condition 2: Register address match
    // Condition 3: Not x0 register
    //
  ...
  when(io.reg_write_enable_mem && (io.rs2_id === io.rd_mem) && (io.rs2_id =/= 0.U)) {
  ...
  }.elsewhen(io.reg_write_enable_wb && (io.rs2_id === io.rd_wb) && (io.rs2_id =/= 0.U)) {
